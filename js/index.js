...
function constructCommitTimeline(commits, repo) {
    ...
    attribution.innerHTML = 'Generated with: <a href="https://github.com/Aizhee" style="text-decoration: none;color: #2600ff4e;">Commit-Line</a> | Made with ❤️ by: <a href="https://github.com/Aizhee" style="text-decoration: none;color: #2600ff4e;">Aizhe</a>';

    commitLine.insertBefore(attribution, timeline);
